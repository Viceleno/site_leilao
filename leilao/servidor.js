...
const porta_bd = "postgresql://neondb_owner:SHg2yYZXitM1@ep-round-lake-a50qe1yo.us-east-2.aws.neon.tech/neondb?sslmode=require";
...
app.listen(porta_bd, () => {
    console.log(`Servidor rodando na porta ${porta_bd}`);
});
